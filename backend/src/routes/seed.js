...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    await Promise.all([
      ...
      Goal.create({ userId: emp3._id, cycleId: cycle._id, thrustArea: 'Retention',            title: 'Customer Retention Rate',        uom: 'percentage',  target: 90,      weightage: 25, status: 'approved', approvedBy: mgr2._id, approvedAt: new Date() }),
    ]);
    ...
    res.json({
      ...
      credentials: {
        ...
        manager2:  'manager2@goalsync.com / Manager@123',
        employee1: 'employee1@goalsync.com / Employee@123',
        employee2: 'employee2@goalsync.com / Employee@123',
        employee3: 'employee3@goalsync.com / Employee@123',
      },
    });
  } catch (err) {
